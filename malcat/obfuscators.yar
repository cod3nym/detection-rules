rule Eazfuscator_String_Encryption : suspicious {
    meta:
	 ...
	 strings:
		 ...
		 $op3 = { 7B ?? 00 00 04 16 91 02 7B ?? 00 00 04 17 91 1E 62 60 02 7B ?? 00 00 04 18 91 1F 10 62 60 02 7B ?? 00 00 04 19 91 1F 18 62 60 } // (int)this.\u0003[0] | ((int)this.\u0003[1] << 8) | ((int)this.\u0003[2] << 0x10) | ((int)this.\u0003[3] << 0x18);
	 condition:
		 uint16(0) == 0x5a4d
		 and all of ($sa*)
		 and 2 of ($op*)
